...
```bash
next-themes, lucide-react, framer-motion, @radix-ui/react-tabs, @radix-ui/react-slot, class-variance-authority, @radix-ui/react-label, @radix-ui/react-dropdown-menu, @radix-ui/react-radio-group
```
